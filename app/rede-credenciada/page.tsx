        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-lg border bg-card p-4">
              <div className="mb-2 text-sm font-medium text-muted-foreground">Total Credenciados</div>
              <div className="text-3xl font-bold">47</div>
              <div className="mt-1 text-xs text-emerald-600">+3 este mes</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="mb-2 text-sm font-medium text-muted-foreground">Score Medio Rede</div>
              <div className="text-3xl font-bold">4.4</div>
              <div className="mt-1 text-xs text-muted-foreground">de 5.0</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="mb-2 text-sm font-medium text-muted-foreground">SLA Medio</div>
