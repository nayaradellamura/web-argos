...
const alertasData: Alerta[] = [
  {
    ...
    tipo: "critico",
    titulo:
      "Sinistro #CLM-1024: IA sinalizou inconsistência grave foto vs. áudio",
    descricao:
      "A análise multimodal detectou divergência significativa entre as fotos do veículo e a descrição de áudio do segurado. Padrão compatível com fraude documentada.",
    sinistroId: "CLM-1024",
    dataHora: "há 5 min",
  ...
  },
  {
    ...
    tipo: "critico",
    titulo:
      "Sinistro #CLM-1089: Dano oculto identificado pela visão computacional",
    descricao:
      "Sistema de IA detectou danos estruturais não reportados no chassi do veículo. Severidade reclassificada de Média para Grande Monta.",
    sinistroId: "CLM-1089",
    dataHora: "há 12 min",
  ...
  },
  {
    ...
    descricao:
      "Verificação automática identificou possível adulteração no documento CRLV anexado. Requer análise manual imediata.",
    sinistroId: "CLM-987",
    dataHora: "há 28 min",
  ...
  },
  {
    ...
    descricao:
      "O prazo de 48h para conclusão da vistoria técnica foi excedido. Sinistro aguardando há 52 horas na oficina Elite Motors.",
    sinistroId: "CLM-1056",
    dataHora: "há 1 hora",
  ...
  },
  {
    ...
    descricao:
      "Faltam apenas 4 horas para o vencimento do SLA de regulamentação técnica. Prioridade de ação recomendada.",
    sinistroId: "CLM-1078",
    dataHora: "há 2 horas",
  ...
  },
  {
    ...
    descricao:
      "Oficina AutoPrime não enviou orçamento dentro do prazo estipulado. Contato automático enviado.",
    sinistroId: "CLM-1034",
    dataHora: "há 3 horas",
  ...
  },
  {
    ...
    descricao:
      "Timeout na consulta de dados veiculares. Sistema tentará reconexão automática em 15 minutos.",
    dataHora: "há 45 min",
    categoria: "Falha API",
    lido: false,
  },
  {
    ...
    descricao:
      "A sincronização de dados financeiros com o sistema ERP falhou. Dados de liquidação podem estar desatualizados.",
    dataHora: "há 2 horas",
  ...
  },
  {
    ...
    descricao:
      "O microserviço de visão computacional está apresentando latência acima do esperado. Time de infraestrutura notificado.",
    dataHora: "há 4 horas",
  ...
  },
  {
    ...
    descricao:
      "Investigação finalizada. Sinistro confirmado como legítimo após análise detalhada.",
    sinistroId: "CLM-956",
    dataHora: "ontem",
    categoria: "Possível Fraude",
    lido: true,
  },
  {
    ...
    descricao:
      "Atraso resolvido após intervenção manual. Processo retomado dentro do prazo.",
    sinistroId: "CLM-912",
    dataHora: "ontem",
    categoria: "SLA Violado",
    lido: true,
  },
  {
    ...
    descricao:
      "Conexão com a API da Detran-RJ foi normalizada após manutenção programada.",
    dataHora: "há 2 dias",
    categoria: "Falha API",
    lido: true,
  },
